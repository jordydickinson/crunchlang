...
let%expect_test _ =
  print_parse_semantic {|
    type t = int64;
  |};
  [%expect {| ((Type (loc (:1:5 :1:20)) (ident t) (constructor Int64))) |}]
...
let%expect_test _ =
  ...
  |};
  [%expect {|
    ((Type (loc (:1:5 :1:20)) (ident t) (constructor Int64))
...
let%expect_test _ =
  ...
  |};
  [%expect {|
    ((Type (loc (:1:5 :1:53)) (ident point)
      (constructor (Struct ((x (Arg 0)) (y (Arg 0))))))) |}]
